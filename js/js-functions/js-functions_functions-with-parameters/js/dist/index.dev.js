...
greetAlice("Alice");
greetBob("Bob");
greetMary("Mary"); // --v-- write your code here --v--
...
greet("Alice");
greet("Bob");
greet("Mary"); // --^-- write your code here --^--
...
var logSeparator = function logSeparator(exerciseNumber) {
  console.log("-------------");
...
logSeparator(3);
logSeparator(4);
logSeparator(5); // --^-- write your code here --^--